...
module.exports = {
    name: "all",
    description: STRINGS.all.DESCRIPTION,
    extendedDescription: STRINGS.all.EXTENDED_DESCRIPTION,
    demo: {
        isEnabled: true,
        text: [
            ".all",
            ".all Hey everyone! You have been tagged in this message hehe.",
        ],
    },
