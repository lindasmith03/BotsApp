...
module.exports = {
    name: "tehelka",
    description: STRINGS.tehelka.DESCRIPTION,
    extendedDescription: STRINGS.tehelka.EXTENDED_DESCRIPTION,
    demo: {
        isEnabled: true,
        text: [
            ".tehelka",
            ".tehelka Hey everyone! You have been tagged in this message hehe.",
        ],
    },
